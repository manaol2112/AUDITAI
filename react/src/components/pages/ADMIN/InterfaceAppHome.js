...
const customMainContent = (
    <div>
        <ResponsiveContainer>
            ...
            <SearchAppBar title="Application Data" icon={<ContactMailIcon />} />
            <mui.Typography sx={{ marginTop: '20px' }} variant="subtitle2" gutterBottom>
                Manage SFTP Settings, Job Schedules, and View Application Import Logs
            </mui.Typography>
...
export default InterfacesAppHome;