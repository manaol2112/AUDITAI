    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CONTROL_CATEGORY', models.CharField(blank=True, max_length=256, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datehired', models.CharField(max_length=50, null=True)),
                ('daterehired', models.CharField(max_length=50, null=True)),
                ('termdate', models.CharField(max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DEVTYPE', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('NETWORK_VERSION', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('PW_CONFIGURABLE', models.CharField(blank=True, max_length=50, null=True)),
                ('CREATED_BY', models.CharField(blank=True, max_length=50, null=True)),
                ('CREATED_ON', models.DateField(auto_now_add=True, null=True)),
                ('LAST_MODIFIED', models.DateTimeField(null=True)),
                ('MODIFIED_BY', models.CharField(default=False, max_length=50, null=True)),
                ('APPLICATION_OWNER', models.ManyToManyField(blank=True, to=settings.AUTH_USER_MODEL)),
                ('COMPANY_ID', models.ForeignKey(blank=True, max_length=100, null=True, on_delete=django.db.models.deletion.CASCADE, to='appAUDITAI.company')),
            ],
            options={
                'db_table': 'APP_LIST',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('JOB_COMPLETE', models.BooleanField(default=False, null=True)),
                ('JOB_ERROR', models.CharField(blank=True, max_length=1000, null=True)),
                ('SOURCE_LINE_COUNT', models.CharField(blank=True, max_length=100, null=True)),
                ('CREATED_COUNT', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('PREPARER', models.ManyToManyField(blank=True, related_name='Preparer', to=settings.AUTH_USER_MODEL)),
                ('REVIEWER', models.ManyToManyField(blank=True, related_name='Reviewer', to=settings.AUTH_USER_MODEL)),
                ('COMPANY_ID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='appAUDITAI.company')),
                ('CONTROL_ID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='appAUDITAI.controllist')),
                ('workpaper_upload', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='appAUDITAI.workpaper_upload')),
            ],
            options={
                'db_table': 'AUDITFILE',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AUDIT_NAME', models.CharField(blank=True, max_length=100, null=True)),
                ('AUDIT_DESCRIPTION', models.CharField(blank=True, max_length=256, null=True)),
                ('AUDIT_TYPE', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('CHECK_AUTH', models.BooleanField(blank=True, default=True, null=True)),
                ('CHECK_PROV', models.BooleanField(blank=True, default=True, null=True)),
                ('CHECK_TERMED', models.BooleanField(blank=True, default=True, null=True)),
                ('CHECK_UAR', models.BooleanField(blank=True, default=True, null=True)),
                ('CHECK_ADMIN', models.BooleanField(blank=True, default=True, null=True)),
                ('APP_NAME', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='appAUDITAI.app_list')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('SFTP_DESTINATION', models.CharField(blank=True, max_length=1000, null=True)),
                ('SETUP_COMPLETE', models.BooleanField(default=False)),
                ('AUTH_KEY', models.CharField(blank=True, max_length=1000, null=True)),
                ('CREATED_BY', models.CharField(blank=True, max_length=50, null=True)),
                ('CREATED_ON', models.DateField(auto_now_add=True, null=True)),
                ('LAST_MODIFIED', models.DateTimeField(null=True)),
                ('MODIFIED_BY', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('LAST_MODIFIED', models.DateTimeField(null=True)),
                ('MODIFIED_BY', models.CharField(blank=True, max_length=50, null=True)),
                ('COMPANY_ID', models.ManyToManyField(blank=True, to='appAUDITAI.company')),
            ],
        ),
        migrations.CreateModel(
            name='POLICIES',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('APPROVERS_OTHER', models.CharField(blank=True, max_length=500, null=True)),
                ('GRANTOR', models.CharField(blank=True, max_length=100, null=True)),
                ('GRANTOR_OTHER', models.CharField(blank=True, max_length=500, null=True)),
                ('PROCESS_DIFFERENCE', models.CharField(blank=True, max_length=100, null=True)),
                ('PROCESS_DIFFERENCE_OTHER', models.CharField(blank=True, max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('RISK_ID', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('RISK_DESCRIPTION', models.CharField(blank=True, max_length=1000, null=True)),
                ('REQUIRED', models.CharField(blank=True, max_length=10, null=True)),
                ('COMPANY_ID', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='appAUDITAI.company')),
            ],
            options={
                'db_table': 'RISKLIST',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('RATING_RATIONALE', models.CharField(blank=True, max_length=1000, null=True)),
                ('APP_NAME', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='appAUDITAI.app_list')),
                ('COMPANY_ID', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='appAUDITAI.company')),
                ('CONTROL_ID', models.ManyToManyField(blank=True, to='appAUDITAI.controllist')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CONTROL_ID', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='appAUDITAI.controllist')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('SCOPE_EXEMPTED', models.CharField(blank=True, max_length=100, null=True)),
