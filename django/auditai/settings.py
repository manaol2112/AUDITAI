...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': '/Users/apple/Desktop/AUDIT-AI PROJECT/AUDITAI/django/celery.log',
        },
    },
    'loggers': {
        'django': {
        ...
        'auditai.celery': {  # Replace 'your_module_name' with the actual module
            'handlers': ['console', 'file'],
            'level': 'DEBUG',
            'propagate': False,
        },
